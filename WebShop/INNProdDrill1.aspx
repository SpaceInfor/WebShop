<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="INNProdDrill1.aspx.cs" Inherits="WebShop.INNProdDrill1" %>
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     $(document).ready(function () {
       $.ajax({
         type: "POST",
         url: "INNProdDrill1.aspx/GetCustomers",
         data: '{}',
       ...
       $("#example1").DataTable(
         {
           ...
           columns: [
             ...
             { 'data': 't_hdst', 'title': 'Sales Order Status' },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ct1" runat="server">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Sales Orders Pending For Production</h1>
        </div>
        <div class="col-sm-6">
