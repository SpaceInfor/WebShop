<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PODSlip.aspx.cs" Inherits="WebShop.PODSlip" %>
...
<head>
    ...
    <script type="text/javascript">
        function validate() {
            if (document.getElementById("t_idoc").value == '') {
                toastr.error('Please select Sales Invoice No');
                return false;
            }
            return true;
        }
    ...
    <script type="text/javascript">
        function Bind_Loading_Lines() {
            $.ajax({
                type: "POST",
                url: "PODSlip.aspx/GetPODLines",
                data: '{t_idoc: "' + document.getElementById("t_idoc").value + '"}',
    ...
    <script type="text/javascript">
        function FinalizePOD() {
            $.ajax(
                {
                    type: "POST",
                    url: "PODSlip.aspx/FinalizeLoading",
    ...
    <script type="text/javascript">
        function AddPOD() {
            ...
            $.ajax(
                {
                    type: "POST",
                    url: "PODSlip.aspx/ProcessIT",
                    data: '{t_idoc: "' + load_id + '",t_orno: "' + document.getElementById("t_orno").value + '",t_carp: "' + document.getElementById("t_carp").value + '",t_lyno:"' + document.getElementById("t_lyno").value.toString() + '",t_lrno:"' + document.getElementById("t_lrno").value + '",t_lrdt:"' + document.getElementById("t_lrdt").value + '",t_boxs:"' + document.getElementById("t_boxs").value + '"}',
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="../../index3.html" class="navbar-brand">
                    ...
                    <span class="brand-text font-weight-light">POD Scan App</span>
                </a>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a class="btn btn-block btn-warning btn-xs" href="PODList.aspx"><i class="fas fa-backward"></i></a></li>
                    ...
                    <div class="container">
                            ...
                            <div class="col-lg-6">
                                <div class="card card-warning card-outline">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-shipping-fast"></i>&nbsp;Details</h3>
                                      <%--fas fa-truck-loading--%>
                                        <div class="card-tools">
                                          <%--  <span class="badge badge-warning">Load No :</span>&nbsp; <span class="float-right username">
                                                <label id="loadid"></label>
                                            </span>--%>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="t_idoc" onchange='getSoDetails(this.value)' class="form-control" />
                                                    <div class="input-group-append">
                                                        <button id="btnMorn" type="button" class="btn btn-block btn-warning" onclick="openChild('t_idoc','HelpPages/tcisli305100_salesInvoice')"><i class="fa fa-fw fa-search"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-sm table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label for="lblt_ofbp">Transaction Type</label></td>
                                                        <td>
                                                            <div class="badge bg-warning">
                                                                <label id="lblt_tran"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label for="lblt_stbp">Sales Order</label>
                                                        </td>
                                                        <td>
                                                            <div class="badge bg-warning">
                                                                <label id="lblt_orno"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label for="lblt_dest">Item</label>
                                                        </td>
                                                        <td>
                                                            <div class="badge bg-warning">
                                                                <label id="lblt_item "></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label for="lblt_bqty">Quantity</label></td>
                                                        <td>
                                                            <div class="badge bg-warning">
                        ...
                        <%--    <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="card card-warning card-outline">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                            <label for="t_boxs">Box No</label>
                                            &nbsp;<input type="text" value="" id="t_boxs" maxlength="12" />
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div id="reader"></div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-warning card-outline">
                                    <div class="card-body">
                                        <button id="btnAdd" type="button" class="btn btn-warning float-left toastrDefaultSuccess" onclick="FinalizePOD();">Finalize POD</button>
                                    </div>
                                </div>
                            </div>
