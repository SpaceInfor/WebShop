...
namespace WebShop
{
  public partial class CSDespDrill1 : System.Web.UI.Page
  {
    ...
    protected void GetOrderList()
    {
      ...
      SqlComm.Parameters.AddWithValue("@t_sect", "DDRL");
      ...
      try
      {
        ...
        foreach (DataTable table in sProdPlanData.Tables)
        {
          ...
          {
            tabl = tabl + "<tr><td><a href='CustOrderEdit.aspx?ORD=" + dr["t_worn"].ToString() + "'><i class='fa fa-fw fa-arrow-right'></i></a></td><td>" + dr["t_bpid"].ToString() + "</td><td>" + dr["bp_code_name"].ToString() + "</td><td>" + dr["t_worn"].ToString() + "</td><td>" + dr["t_scbp"].ToString() + "</td><td>" + dr["t_qtyp"].ToString() + "</td><td>" + dr["t_date"].ToString() + "</td><td>" + dr["t_incl"].ToString() + "</td><td>" + dr["t_dlcd"].ToString() + "</td><td>" + dr["Sales_Order"].ToString() + "</td><td>" + dr["Sales_Order_date"].ToString() + "</td><td>" + dr["t_item"].ToString() + "</td><td>" + dr["Sales_Qty"].ToString() + "</td><td>" + dr["t_cuni"].ToString() + "</td><td>" + dr["Sales_Amount"].ToString() + "</td><td>" + dr["t_fgmt"].ToString() + "</td><td>" + dr["t_cwar"].ToString() + "</td> </tr>";
          }
        }
