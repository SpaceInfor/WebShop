<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="INNPlanDrill1.aspx.cs" Inherits="WebShop.INNPlanDrill1" %>
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     $(document).ready(function () {
       $.ajax({
         type: "POST",
         url: "INNPlanDrill1.aspx/GetCustomers",
         data: '{}',
       ...
       $("#example1").DataTable(
         {
           ...
           columns: [
             ...
             { 'data': 't_oamt', 'title': 'Sales Order Amt' },
             { 'data': 't_prep', 'title': 'Pre Planned Qty' },
             { 'data': 't_cwar', 'title': 'Warehouse' },
             { 'data': 't_clco', 'title': 'Calculation Office' },
             { 'data': 't_pdno', 'title': 'Production Order No' },
             { 'data': 't_podt', 'title': 'Production Order Date' }]
...
<asp:Content ID="Content2" ContentPlaceHolderID="ct1" runat="server">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Sales Orders Pending For Planning</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Sales Orders Pending For Planning</h3>
