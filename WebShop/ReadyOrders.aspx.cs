...
namespace WebShop
{
  public partial class ReadyOrders : System.Web.UI.Page
  {
    ...
    public static List<SalesOrderClass> GetCustomers()
    {
      ...
      {
        using (SqlCommand cmd = new SqlCommand("exec  WS_CustOrderList_details @t_sect='REDY' , @t_ofbp = '" + r_ofbp + "'"))
    ...
    public static List<SalesOrderClass> GetFOCOrders()
    {
      ...
      using (SqlConnection con = new SqlConnection(constr))
      {
        using (SqlCommand cmd = new SqlCommand("exec WS_CustOrderList_details_FOC @t_sect='REDY' , @t_ofbp = '" + r_ofbp + "'"))
        //using (SqlCommand cmd = new SqlCommand("exec  WS_CustOrderList_details @t_sect='DTL1'"))
        {
          cmd.Connection = con;
          List<SalesOrderClass> SalesOrders = new List<SalesOrderClass>();
