<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tcisli305100_salesInvoice.aspx.cs" Inherits="WebShop.HelpPages.tcisli305100_salesInvoice" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Bind_SalesInvoice() {

            $.ajax({

                type: "POST",
                url: "tcisli305100_salesInvoice.aspx/GetSalesInvoiceDetails",
                        ...
                        columns: [
                            ...
                            //{ 'data': null, title: "Select", wrap: true, "render": function (item) { return '<div button type="button" class="btn btn-block btn-secondary" OnClick=javascript:GetSelectedRow("' + row.t_orno.ToString() + '")><i class="fas fa-arrow-circle-left"></i></button></div>' } },
                            {
                                ...
                                data: null, "title": "Select", render: function (data, type, row, meta) {
                                    ...
                                    return '<a href="#" class="btn btn-block btn-secondary" onclick=javascript:GetSelectedRow("' + row.t_idoc + '")><i class="fas fa-arrow-circle-left"></i></a></div>';
                                    //return '<a href="#"  class="badge bg-primary btnRetriveProdShape"><i class="fa fa-backward"></i></a>';
                                }
                            },
                            { "data": "t_idoc", "title": "Sales Invoice" },
