...
namespace WebShop.HelpPages
{
    public partial class UserList : System.Web.UI.Page
    {
        ...
        protected void getBpList()
        {
            ...
            if (communication == 1)
            {
                SqlComm.CommandText = "SELECT T1.t_usid,T2.t_nama as t_usiddesc,T1.t_dept,T3.t_desc as t_deptdesc,T1.t_levl from swlive..ttdtst170100 As T1 inner join swlive..ttdtst250100 As T2 ON T1.t_usid = T2.t_usid inner join swlive..ttdtst167100 As T3 ON T1.t_dept = T3.t_dept where T1.t_levl=1 or T1.t_levl=2";
            }
            else
            {
