                    ...
                    success: function (data) {
                        ...
                        var datatableVariable = $('#tblbookingdetails').DataTable({
                            ...
                            columns: [
                                ...
                                { 'data': null, title: 'Delete', wrap: true, "render": function (item) { return '<div class="btn-group"><button type="button" onclick="delete_row(' + "'" + item.t_bkno + "'" + ',' + item.t_pono + ')" value="0" class="btn btn-danger btn-sm"> <i class="far fa-trash-alt"></i></button></div>' } }
