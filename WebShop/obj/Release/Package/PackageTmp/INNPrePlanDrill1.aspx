<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="INNPrePlanDrill1.aspx.cs" Inherits="WebShop.INNPrePlanDrill1" %>
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     $(document).ready(function () {
       $.ajax({
         type: "POST",
         url: "INNPrePlanDrill1.aspx/GetCustomers",
         data: '{}',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ct1" runat="server">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Sales Orders Pending For Pre-Planning</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Sales Orders Pending For Pre-Planning</h3>
