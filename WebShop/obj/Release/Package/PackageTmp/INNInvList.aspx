<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="INNInvList.aspx.cs" Inherits="WebShop.INNInvList" %>
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     $(document).ready(function () {
       $.ajax({
         type: "POST",
         url: "INNInvList.aspx/GetCustomers",
         data: '{}',
       ...
       $("#example1").DataTable(
         {
           ...
           columns: [
             ...
             { 'data': 't_date', 'title': 'Invoice Date' },
             { 'data': 't_cbrn', 'title': 'Line Of Business' },
             { 'data': 't_item', 'title': 'Item Code' },
             { 'data': 't_item_desc', 'title': 'Item Description' },
             { 'data': 't_dqua', 'title': 'Despatched Qty' },
             { 'data': 't_pric', 'title': 'Rate' },
             { 'data': 't_amti', 'title': 'Inv Amount' },
             { 'data': 't_orno', 'title': 'Sales Order No' },
             { 'data': 't_worn', 'title': 'Quotation No' },
             { 'data': 't_lrno', 'title': 'LR No' },
             { 'data': 't_lrdt', 'title': 'LR Date' },
             { 'data': 't_lyno', 'title': 'Vehicle No' },
             { 'data': 'transporter', 'title': 'Transporter' },
             { 'data': 't_fpon', 'title': 'Eway-Bill no' }]
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">List Of INNOPAN Invoices</h3>
