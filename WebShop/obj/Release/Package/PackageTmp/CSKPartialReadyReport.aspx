<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CSKPartialReadyReport.aspx.cs" Inherits="WebShop.CSKPartialReadyReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <link rel="stylesheet" href="../../dist/css/adminlte.min.css">
  <title>PARTIALLY READY ORDERS REPORT</title>
     ...
     <script type="text/javascript">
       function get_all_orders() {
         $.ajax({
           type: "POST",
           url: "CSKPartialReadyReport.aspx/GetCustomers",
           data: '{}',
   ...
   <script type="text/javascript">
     function get_foc_orders() {
       $.ajax({
         type: "POST",
         url: "CSKPartialReadyReport.aspx/GetFOCOrders",
         data: '{}',
         contentType: "application/json; charset=utf-8",
         dataType: "json",
         success: OnSuccess,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ct1" runat="server">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>List of Partially Ready Orders</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a  href="CSDashboard.aspx">Home</a></li>
            <li class="breadcrumb-item active">Partially Ready Orders Report</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Partially Ready Orders Report</h3>
