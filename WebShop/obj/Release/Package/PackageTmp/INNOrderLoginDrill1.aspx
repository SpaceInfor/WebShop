<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="INNOrderLoginDrill1.aspx.cs" Inherits="WebShop.INNOrderLoginDrill1" %>
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     $(document).ready(function () {
       $.ajax({
         type: "POST",
         url: "INNOrderLoginDrill1.aspx/GetCustomers",
         data: '{}',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ct1" runat="server">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Sales Quotations Pending For Log-In</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Sales Quotations Pending For Log-In</h3>
