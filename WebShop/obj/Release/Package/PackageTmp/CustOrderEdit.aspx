  <%@ Page Title="" Language="C#" MasterPageFile="~/WebShop.Master" AutoEventWireup="true" CodeBehind="CustOrderEdit.aspx.cs" Inherits="WebShop.CustOrderEdit" %>
        ...
        $.ajax(
          {
              ...
              data: '{t_refb: "' + $("#<%=t_refb.ClientID%>")[0].value + '",t_ofbp:"' + $("#<%=t_ofbp.ClientID%>")[0].value + '",t_morn:"' + mainorder + '",t_incl:"' + $("#<%=t_incl.ClientID%>")[0].value + '",t_dlcd:"' + $("#<%=t_dlcd.ClientID%>")[0].value + '",t_item:"' + $("#<%=t_item.ClientID%>")[0].value + '",t_qoor:"' + $("#<%=t_qoor.ClientID%>")[0].value + '",t_qtyp:"' + quottype + '",t_rmrk:"' + $("#<%=t_rmrk.ClientID%>")[0].value + '"}',
            ...
            <div class="card-header">
              ...
              <div class="card-body">                
                ...
                <div class="card-footer">
                  <asp:LinkButton ID="btnEditOrder" runat="server" class="btn btn-warning float-left" onclick="btnEdit_Click"><i class="fas fa-plus"></i>Save</asp:LinkButton>
                </div>
            </div>
          </div>
      </div>
