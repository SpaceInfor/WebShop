...
namespace WebShop
{
  public partial class RecOpen_Details : System.Web.UI.Page
  { 
    ...
    protected void GetInventory()
    {
      ...
      try
      {
        ...
        foreach (DataTable table in sProdPlanData.Tables)
        {
          ...
          {
            tabl = tabl + "<tr><td>" + dr["t_bpid"].ToString() + "</td><td>" + dr["t_cwar"].ToString() + "</td><td>" + dr["t_item"].ToString() + "</td><td>" + dr["t_desc"].ToString() + "</td><td>" + dr["t_orec"].ToString() + "</td><td>" + dr["t_cuni"].ToString() + "</td><td>" + dr["t_amnt"].ToString() + "</td></tr>";
          }
        }
