...
namespace WebShop
{
  public partial class CSKPartialReadyReport : System.Web.UI.Page
  {
    ...
    public static List<SalesOrderClass> GetCustomers()
    {
      ...
      {
        using (SqlCommand cmd = new SqlCommand("exec  WS_CustOrderList_details @t_sect='PARTR' , @t_ofbp = '" + r_ofbp + "'"))
        {
          cmd.Connection = con;
    ...
    public static List<SalesOrderClass> GetFOCOrders()
    {
      ...
      using (SqlConnection con = new SqlConnection(constr))
      {
        using (SqlCommand cmd = new SqlCommand("exec  WS_CustOrderList_details_foc @t_sect='PARTR' , @t_ofbp = '" + r_ofbp + "'"))
        {
          cmd.Connection = con;
          List<SalesOrderClass> SalesOrders = new List<SalesOrderClass>();
          con.Open();
