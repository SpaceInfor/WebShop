...
namespace WebShop
{
  public partial class CSPlanDrill1 : System.Web.UI.Page
  {
    ...
    protected void GetOrderList()
    {
      ...
      try
      {
        ...
        foreach (DataTable table in sProdPlanData.Tables)
        {
          ...
          {
            if (Convert.ToInt16(dr["t_qoor"]) > Convert.ToInt16(dr["t_prod"]))
            {
              tabl = tabl + "<tr><td><a href='CustOrderEdit.aspx?ORD=" + dr["t_worn"].ToString() + "'><i class='fa fa-fw fa-arrow-right'></i></a></td><td>" + dr["t_bpid"].ToString() + "</td><td>" + dr["bp_code_name"].ToString() + "</td><td>" + dr["t_worn"].ToString() + "</td><td>" + dr["t_qtyp"].ToString() + "</td><td>" + dr["t_date"].ToString() + "</td><td>" + dr["t_incl"].ToString() + "</td><td>" + dr["t_dlcd"].ToString() + "</td><td>" + dr["Sales_Order"].ToString() + "</td><td>" + dr["Sales_Order_date"].ToString() + "</td><td>" + dr["t_item"].ToString() + "</td><td>" + dr["t_qoor"].ToString() + "</td><td>" + dr["t_cuni"].ToString() + "</td><td>" + dr["t_oamt"].ToString() + "</td><td>" + dr["t_pdno"].ToString() + "</td><td>" + dr["t_podt"].ToString() + "</td><td>" + dr["t_cwar"].ToString() + "</td><td>" + dr["t_clco"].ToString() + "</td> </tr>";
            }
          }
        }
